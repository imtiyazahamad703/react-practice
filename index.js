...
// ============================================
// Read All Clicked- User3 update bhool gaye!
// ============================================
document.getElementById('btn').onclick = function() {
    ...
    // FORGOT: document.getElementById('u3').textContent = '0';
    
    // ============================================
    // GHOST MESSAGE!
    // Data: users = [0, 0, 0]
    // UI shows: User1=0, User2=0, User3=2 (still old!)
    // ============================================
    
    console.log('Data (State):', users);        // [0, 0, 0]
    console.log('UI shows User3:', document.getElementById('u3').textContent);  // 2
    console.log('GHOST MESSAGE! Data says 0, UI shows 2!');
};
